...
<body>
    <section class="top-nav">
        ...
        <ul class="menu-navbar">
          ...
          <li class="123"><a href="crud/index.php">masuk</a></li>
          <!-- <li class="123"><a href=""><form action="logout.php" method="post" class="login-email"><button type="submit" name="logout" class="btn">logout</button> -->
                        <!-- </form></a></li> -->
          <div class="container-logout">
          <li class ="123" ><a href="" form action="" method="POST" class="login-email">     
